...
class _AddTaskState extends State<AddTask> {
  ...
  final Map<String, int> taskTypeToColorId = {
    'Görev': 0,
    'Toplantı': 1,
    'Not': 2,
  };
                  ...
                  child: Center(
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (String? newValue) {
                        setState(() {
                          colorId = taskTypeToColorId[newValue] ?? 0;
                          print(colorId);
                        });
                      },
                      items: taskTypeToColorId.keys.map((String key) {
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  if (taskName.text.isEmpty ||
                    ...
                    taskTypeToColorId.forEach((key, value) {
                      if (key == taskName.text) {
